...
const Footer = () => {
    return (
        <>
            <footer className="relative max-w-7xl w-11/12 mt-20 mx-auto z-10 bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
                <div className="max-w-7xl mx-auto">
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                            <div className="mb-10 w-full ">
                                <a href="/#" className="mb-6 flex items-center max-w-[160px]">
                                    <img
                                        src={logo}
                                        alt="logo"
                                        className="rounded-full w-20 h-20 dark:hidden"
                                    />
                                   <h1 className="font-bold text-2xl ml-2">MedlinePlus</h1>
                                </a>
